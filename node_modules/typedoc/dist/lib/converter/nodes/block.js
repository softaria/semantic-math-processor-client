...
let BlockConverter = class BlockConverter extends components_1.ConverterNodeComponent {
    ...
    convertSourceFile(context, node) {
        ...
        const inputFiles = this.inputFiles.map(file => path_1.resolve(file).replace(/\\/g, '/'));
        const isInputFile = (node) => inputFiles.includes(node.fileName);
        context.withSourceFile(node, () => {
            ...
            else if (this.mode === utils_1.SourceFileMode.Library) {
...
], BlockConverter.prototype, "inputFiles", void 0);
